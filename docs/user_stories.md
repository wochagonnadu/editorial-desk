...
- `024` переоткрыт: после отката UI-polish вернулись partial-истории по hero/team/workflow и motion/editorial tone; local portraits и optimized assets оставлены.
- Оставшиеся `partial` истории после 024 снова привязаны к `024`, а manager onboarding/live setup закрыты отдельными `025/026`; экспертский public-doc flow остается в `TD-014`.
