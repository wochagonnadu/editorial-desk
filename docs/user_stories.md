...
4. [partial][must] Как пользователь, я хочу чтобы email-onboarding эксперта проходил шаги 1->5 без обрыва, чтобы voice acquisition был рабочим.
5. [partial][should] Как пользователь, я хочу видеть статус готовности voice profile, чтобы понимать, когда можно генерировать в голосе эксперта.
