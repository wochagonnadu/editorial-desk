...
## Global art direction (apply to every avatar)

* **Format:** head-and-shoulders portrait, centered, consistent framing across all characters
* **Style:** warm semi-realistic illustration, soft studio lighting, subtle paper grain texture
* **Palette:** warm beige background, terracotta accents, soft gray neutrals; muted sage allowed for one role
* **Backgrounds:** minimal, soft-focus, *no readable text*, only faint icons/shapes
* **Clothing:** modern professional-casual, varied silhouettes, no heavy patterns
* **Diversity rule:** each person must be **visibly distinct** (different age group, ethnicity, face shape, hairstyle). No “same face” reuse.

---

## 1) Morgan — Editor-in-Chief

**Role:** Keeps the whole workflow moving, decides “what’s next,” protects priorities.
**Personality:** Calm, decisive, reassuring.
...
## 2) Casey — The Interviewer

**Role:** Captures each expert’s voice through short, respectful questions.
**Personality:** Warm, efficient, attentive.
...
## 3) Rowan — Voice Stylist

**Role:** Makes the text sound like the expert: cadence, phrasing, signature language.
**Personality:** Detail-oriented, playful, authenticity-obsessed.
...
## 4) Blair — Structure Editor

**Role:** Clarity and structure: short answer first, headings, examples, FAQ, next steps.
**Personality:** Practical, organized, hates fluff.
...
## 5) Avery — Fact Checker

**Role:** Flags check-worthy statements, confirms them, or proposes safer wording.
**Personality:** Evidence-minded, politely skeptical.
...
## 6) Jordan — Compliance Officer

**Role:** Catches risky promises, absolutes, unsafe advice, ensures disclaimers are present.
**Personality:** Firm, fair, protective.
...
**Role:** Makes the text feel natural and human: removes template-y phrasing, smooths rhythm.
**Personality:** Gentle, empathetic, loves simple words.
...
## 8) Quinn — Revision Coordinator

**Role:** Consolidates comments into a single change plan, ensures nothing gets lost.
**Personality:** Kind perfectionist, loves clean checklists.
...
## 9) Taylor — Quality Gatekeeper

**Role:** Final call: review-ready, needs work, or needs expert confirmation. Lists blockers clearly.
**Personality:** Objective, consistent, dependable.
...
## Consistency checklist (before generating)

* No readable text anywhere (only lines, blocks, checkmarks).
* Each character: different age + ethnicity + face shape + hairstyle.
* Same framing, same lighting, same warm pastel palette.
* Role readability: prop + badge/icon + outfit silhouette must communicate the job.
